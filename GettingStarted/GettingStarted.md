...
>Note: The logo first needs to be added as a web resource before it can be used.
>Navigate to Settings ➡️ Customise the system

  ![alt text](image-33.png)

Navigate to Components ➡️ Web Resources
